# $Id: control.py 1367 2007-11-22 01:52:42Z oliver $
#
...
class server:
    ...
    def __init__(self,vmdbinary='vmd',
                 ...
                 force=False,maxdelay=10,dispdev='win'):
        ...
        * starting multiple VMD processes does not work as we always use the same port
        ...
        self.startcmd = '%s -e %s' % (self.vmdbinary, self.server_tcl)
...
class command(client):
    ...
    def __init__(self,*commands):
        ...
        for c in self._cmds:
            ...
            cl = client('127.0.0.1')       # what a waste--single command exchange
            cl.cmd(c + "\n")
            asyncore.loop()
            r = cl.response()
            r = re.sub('\r\n','\n',r)
